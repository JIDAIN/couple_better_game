...
- 首页活动场景接入两位女孩透明角色图；
- 新增 `excited` 数据值与独立 migration；Production migration 已于 2026-09-03 执行并验证。

R7 页面级收口已完成：今日、饮食、餐食编辑、日历、日期详情、小窝、体重、小信箱、家庭药箱、游戏机和我的已统一移动端密度、返回操作、工具栏、卡片与空态。详细记录见 `docs/24-r7-mobile-ui-calibration.md`。

R7 实机反馈修正已完成：账号切换会立即清理旧身份缓存，登录阶段并行预热常用生活数据；首页心情去除外框并放大，月历心情提高可辨识尺寸；小信箱增加月份归档并改为日期轴信纸列表。

R7 已于 2026-09-03 在取得单次授权后部署 Production，并立即重新关闭 Git 自动部署。后续根据真实手机反馈继续校准首页构图、餐食长文本和各子页面弹层；任何后续 Vercel Preview / Production 仍须重新取得单次明确授权。
