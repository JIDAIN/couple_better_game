...
export type LinkedDailyGameOverview = {
  hasRecord: boolean;
...
export type DailyMealsPanelCoreProps = {
  getLinkedGameOverview?: (
    date: string,
    partner: NutritionPartnerKey,
  ) => LinkedDailyGameOverview | null;
};
...
export function DailyMealsPanelCore({
  getLinkedGameOverview,
}: DailyMealsPanelCoreProps) {
  ...
  const gameOverview = useMemo(
    ...
    [getLinkedGameOverview, selectedDate, selectedPartner],
  );
