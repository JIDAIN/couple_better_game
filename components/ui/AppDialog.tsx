...
export function AppModal({ typewriter = false, ...props }: AppModalProps) {
  return <AnimalModal {...props} typewriter={typewriter} />;
}
...
export type AppDialogBackdropProps = HTMLAttributes<HTMLButtonElement> & {
  children?: ReactNode;
};
