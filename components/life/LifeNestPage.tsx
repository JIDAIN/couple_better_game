...
export function LifeNestPage() {
  return (
    <AppPageShell title="小窝" subtitle="不常用、但属于我们生活的东西，都收在这里。">
      ...
      <section className="mt-3 rounded-[var(--life-radius-card)] bg-[var(--life-surface-warm)] px-4 py-3"><p className="text-xs font-bold text-[var(--life-text-body)]">小窝正在逐步接入真实数据</p><p className="mt-1 text-[11px] leading-5 text-[var(--life-text-muted)]">体重、家庭药箱和小信箱已经可用；下一步只剩游戏机列表。</p></section>
    </AppPageShell>
  );
}
