    ...
    <AppPageShell title="我的">
      {loading ? (
        ...
        <div className="grid gap-3">
          <section className="life-account-hero life-account-hero-v3">
            <div className="life-account-avatar" aria-hidden>{accountIcon}</div>
            <div className="min-w-0 flex-1">
              <p className="text-lg font-black text-[var(--life-text)]">{accountName}</p>
            </div>
          </section>

          <section className="life-settings-list life-settings-list-v3">
            <div className="life-settings-row">
              <span className="life-settings-icon" aria-hidden>☁️</span>
              <div className="min-w-0 flex-1"><p className="text-sm font-extrabold">云端同步</p></div>
          ...
          <Link href="/me/data" className="life-surface life-me-data-card flex items-center gap-3 rounded-[var(--life-radius-card)] p-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-[10px] leading-4 text-[var(--life-text-muted)]">备份、导出、导入和恢复。</p>
            </div>
